...
class ExplorationService:
    ...
    def get_table_preview(self,table_ref:str,limit:int=10) -> str:
        ...
        try:
            ...
            result = (f"Preview of table '{table} "
    ...
    def get_column_statistics(self,table_ref:str,column:Optional[str]=None) -> str:
    ...
    def _get_single_column_stats(self,table:str,column:str,table_schema:dict) -> str:
    ...
    def query_table_data(self,user_text:str,table_ref:Optional[str]=None,
                         rows_budget:Optional[int]= None,
                         limit:Optional[int] = None) -> str:
        """Query data from a table."""
        
        try:
            request = MCPRequest(user_text=user_text,table=table_ref,
                                 rows_budget=rows_budget,limit=limit)
